...
public class NginxController {
    ...
    /**
     * curl -i "http://localhost:8080/nginx/serverSuccessOrError/502?uuid=sfddfd"
     *
     * @param code
     * @param response
     */
    @RequestMapping("/serverSuccessOrError/{code}")
    public void serverSuccessOrError(@PathVariable("code") int code, String uuid, HttpServletResponse response) {
